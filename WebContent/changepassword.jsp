...
<body class="">
    ...
    -->
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					<li class="active" ><a href="welcome.jsp" > <i
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								...
								<p class="category">Here you change your login password</p>
							</div>
							<div class="card-body">
								<div class='col-md-6'>
									<%
						...
						<label> Email ID </label> <input type=text readonly="readonly"
							...
							Your Current Password </label> <input type=password class='form-control'
							name='oldpassword' placeholder='Current Password' /> <br /> <label>
							Chose Your New Password </label> <input type=password
							class='form-control' name='newpassword'
							placeholder='New Password' /> <br /><br /> 				<button class="btn btn-primary btn-lg btn-block" type="submit">Change Password</button>
					</form>
