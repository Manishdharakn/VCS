    ...
    -->
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="active"><a href="createfile.jsp" > <i
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<h5 class="title">Create File</h5>
								<p class="category">Here, you can create a new File on the HDFS. The file will be saved on the Data path you have configured.</p>
							</div>
							<div class="card-body">
								...
								<div class='col-md-12'>
									...
									<%
										...
										{
										   %>
										   		No Data Path have been configured for your Account. You cannot add files to the Hadoop System without configuring Data path
										   		<hr/>
										   		Please <a href='path.jsp'><i class='fa fa-folder-open'></i> Click here</a> to configure the Data path
										   		<br/><br/>
										   <%
										}
										else
										{
										   %>
												...
												Please fill out the below form to write a new File.
												<br/><br/>
												
												<%
													String done = request.getParameter("done");
										   		    if (done != null && done.equals("yes"))
										   		    {
										   		       %>
										   		       	
										   		       		<i class='fa fa-thumbs-up' style='font-size:28px;'></i> <b>Successfully created a new File on HDFS</b>
										   		       		<br/>
										   		       		<br/>
										   		       		 
										   		       		<a href='createfile.jsp'><i class='fa fa-backward'></i> Create another File</a>
												...
												%>
														...
														<form action='file' method=post id='form' >
															<input type=hidden name='requestType' value='write' />
															<label>Name this File</label>
															<input type=text name='name' placeholder="File name" class='form-control' />
															<br/>
															<label>File Contents</label>
															<textarea style='width:100%; height:300px;' name='contents' required="required"></textarea> 
															<br/>
															<input id='submit' onclick='submitForm();' type=submit value='Save File' class='btn btn-primary' />
														</form> 	
														
														<img style='display: none;' id='loading' src='loading.gif' width=100 />														
												<% } %>									   		
										   <% 
										}
									%>
